...
window.TILE_DEFS = {
  ...
  tree:  {
    ...
    walkable: false,
    description: "A sturdy tree. Looks like it could be chopped for wood.",
    actions: ["gather_wood"]
  },
...
window.ITEM_DEFS = {
  wood_log: { img: "assets/items/TestLog.png", name: "Wood Log" },
  dkky: { img: "assets/items/dockKey.png" },
  book: { img: "assets/items/book.png" },
};
